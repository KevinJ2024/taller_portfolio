      ...
      <TextBox>
        <div>
            ...
            <div className="logo-box">
              ...
              <img className="logos" src="../taller_portfolio/src/assets/images/logoCiudad.png" alt="logo-ciudad"></img>
            </div>
        </div>
        <div>
            ...
            <div className="logo-box">
              ...
              <img className="logos" src="../taller_portfolio/src/assets/images/logoquindio.png" alt="logo-quindio"></img>
            </div>
        </div>
        <div>
            ...
            <div className="logo-box">
              ...
              <img className="logos" src="../taller_portfolio/src/assets/images/logoSena.png" alt="logo-sena"></img>
            </div>
        </div>
      </TextBox>
    </Main>
