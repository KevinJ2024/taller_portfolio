      ...
      <TextBox>
        <div>
            ...
            <div className="logo-box">
              ...
              <img className="logos" src="../src/assets/images/logoCiudad.png" alt="logo-ciudad"></img>
            </div>
        </div>
        <div>
            ...
            <div className="logo-box">
              ...
              <img className="logos" src="../src/assets/images/logoquindio.png" alt="logo-quindio"></img>
            </div>
        </div>
        <div>
