      ...
      <TextBox>
        <div>
            ...
            <div className="logo-box">
              ...
              <img className="logos" src="../../assets/images/logoCiudad.png" alt="logo-sena"></img>
            </div>
        </div>
        <div>
            ...
            <div className="logo-box">
              ...
              <img className="logos" src="../../assets/images/logoquindio.png" alt="logo-sena"></img>
            </div>
        </div>
        <div>
            ...
            <div className="logo-box">
              ...
              <img className="logos" src="../../assets/images/logoSena.png" alt="logo-sena"></img>
            </div>
        </div>
      </TextBox>
    </Main>
